...
// import all pages (Home, About, Services, User etc.)
    ...
    return(
        <>
            ...
            <Switch>
                ...
                */}
                {/* Using Componet  */}
                <Route exact path='/' render={()=> <Home name="Home"/>} /> {/* By Default this is home page or main or opening page, when path='/' */}
                ...
                <Route exact path='/user/:fname/:lname' render={()=> <User name="User"/>} />
                {/* 
